...
This is a library for the Arduino that interfaces with the Pololu "LSM303DLH 3D compass and accelerometer carrier":http://www.pololu.com/catalog/product/1250. It lets you access the raw accelerometer and magnetometer data, and it has a function for computing the tilt-compensated heading, which makes it easy to use this sensor into a tilt-compensated compass.
