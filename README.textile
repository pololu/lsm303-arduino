...
- @int heading(void)@ := Returns the tilt-compensated heading of the negative Y axis in degrees (the angular difference in the horizontal plane between -Y and north).
- @int heading(vector from)@ := Returns the tilt-compensated heading of the given vector in degrees (the angular difference in the horizontal plane between from and north).
